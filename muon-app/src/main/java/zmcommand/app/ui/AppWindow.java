...
import zmcommand.app.ui.components.session.SessionListPanel;
import zmcommand.app.ui.components.session.files.transfer.BackgroundFileTransfer;
import zmcommand.app.ui.components.session.files.transfer.BackgroundTransferPanel;
import zmcommand.app.ui.components.settings.SettingsDialog;
import zmcommand.app.ui.components.settings.SettingsPageName;
import zmcommand.app.updater.UpdateChecker;
...
public class AppWindow extends JFrame {
	...
	public static final String HELP_URL = "https://wiki.zmcontrol.com/";
	public static final String GITHUB_URL = "https://www.zmcontrol.com/";

	/**
	 * 
	 */
	public AppWindow() {
		super("zmterm - Free Edition");
		try {
			this.setIconImage(ImageIO.read(AppWindow.class.getResource("/zmterm.png")));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private Component createBottomPanel() {
		...
		JLabel lblBrand = new JLabel("zmterm 1.0.4");
		...
		JLabel lblUrl = new JLabel("https://www.zmcontrol.com/");
