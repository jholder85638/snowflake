 ...
 * 
 */
package zmcommand.app.ui.components.session.zmutilpage.sysload;
 ...
 *
 */
public class ZMSysLoadPage extends ZMUtilPageItemView {
	 ...
	 * 
	 */
	public ZMSysLoadPage(SessionContentPanel holder) {
		super(holder);
	}
