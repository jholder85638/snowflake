...
import zmcommand.app.ssh.PortForwardingSession;
import zmcommand.app.ssh.RemoteSessionInstance;
import zmcommand.app.ssh.SshFileSystem;
import zmcommand.app.ui.components.DisabledPanel;
import zmcommand.app.ui.components.session.diskspace.DiskspaceAnalyzer;
...
import zmcommand.app.ui.components.session.files.transfer.FileTransfer;
import zmcommand.app.ui.components.session.files.transfer.FileTransfer.ConflictAction;
import zmcommand.app.ui.components.session.files.transfer.TransferProgressPanel;
import zmcommand.app.ui.components.session.logviewer.LogViewer;
import zmcommand.app.ui.components.session.processview.ProcessViewer;
import zmcommand.app.ui.components.session.search.SearchPanel;
import zmcommand.app.ui.components.session.terminal.TerminalHolder;
import zmcommand.app.ui.components.session.utilpage.UtilityPage;
import util.LayoutUtilities;
import zmcommand.app.ui.components.session.zmutilpage.ZMUtilityPage;
...
public class SessionContentPanel extends JPanel implements PageHolder, CachedCredentialProvider {
	...
	private ZMUtilityPage zmUtilityPage;
