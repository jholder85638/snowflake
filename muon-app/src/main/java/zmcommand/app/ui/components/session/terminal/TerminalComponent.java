package zmcommand.app.ui.components.session.terminal;
...
import zmcommand.app.ui.components.session.terminal.ssh.DisposableTtyConnector;
import zmcommand.app.ui.components.session.terminal.ssh.SshTtyConnector;
...
public class TerminalComponent extends JPanel implements ClosableTabContent {
	...
	private ClosableTabbedPanel.TabTitle tabTitle;
	...
	public TerminalComponent(SessionInfo info, String name, String command, SessionContentPanel sessionContentPanel) {
		...
		this.name = name;
		this.tabTitle = new ClosableTabbedPanel.TabTitle();
...
//
	 ...
	 * @return the tabTitle
	 */
	public ClosableTabbedPanel.TabTitle getTabTitle() {
		return tabTitle;
	}
}
